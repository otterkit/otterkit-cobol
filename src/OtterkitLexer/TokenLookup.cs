...
public static class TokenLookup
{
    ...
    {
        return ReservedLookup.ContainsKey(value);
    }

    public static bool IsStandardClause(string value)
    {
    ...
    public static bool IsStandardStatement(string value)
    {
        ref var context = ref CollectionsMarshal.GetValueRefOrNullRef(ContextLookup, value);
    ...
    public static bool IsOtterkitDevice(string value)
    {
        ref var context = ref CollectionsMarshal.GetValueRefOrNullRef(ContextLookup, value);
    ...
    public static bool IsFigurativeLiteral(string value)
    {
        ref var context = ref CollectionsMarshal.GetValueRefOrNullRef(ContextLookup, value);
    ...
    public static bool IsStandardSymbol(string value)
    {
        ref var context = ref CollectionsMarshal.GetValueRefOrNullRef(ContextLookup, value);
    ...
    public static bool IsStandardIntrinsic(string value)
    {
        ref var context = ref CollectionsMarshal.GetValueRefOrNullRef(ContextLookup, value);
    ...
    internal static Dictionary<string, int> ReservedLookup = new(StringComparer.OrdinalIgnoreCase)
    {
        {"ACCEPT",                          0},
        {"ACCESS",                          0},
        {"ACTIVE-CLASS",                    0},
    ...
    internal static Dictionary<string, int> ContextLookup = new(StringComparer.OrdinalIgnoreCase)
    {
        // TokenContext
        // None         = 0
        // IsClause     = 1
    ...
    internal static Dictionary<string, int> IntrinsicLookup = new(StringComparer.OrdinalIgnoreCase)
    {
        {"ABS",                         0},
        {"ACOS",                        0},
        {"ANNUITY",                     0},
