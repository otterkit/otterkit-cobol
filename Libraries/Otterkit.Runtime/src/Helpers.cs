...
public static class RuntimeHelpers
{
    ...
    // WARNING: Do not edit this method manually, the values are generated using the GenerateUtf8Lookup method.
    ...
    public static void GenerateUtf8Lookup(params string[] strings)
    {
        ...
        {
            ReadOnlySpan<char> name = strings[i];

            Encoding.UTF8.GetBytes(name, span);

            Console.Write("[ ");

            foreach (var _byte in span)
            {
                if (_byte == 0) break;
